	...
	<div className="container flex gap-3  ">
		...
		<div className="flex w-2/5 flex-col space-y-6 p-6 rounded-sm justify-start py-10 ">
			...
			<div className="flex justify-between ">
			     ...
			     <p className='text-lg font-medium text-[#FFA000]  '>{available}</p> 
			     <p className='text-lg font-medium  text-[#FFA000] '>{available}</p> 
			</div>
			<div className="flex gap-2 ">
			     <h3 className='text-xl font-bold  text-[#0F0F0F] '>  Consultation Free: </h3>
			     <p className='text-lg font-bold text-[#176AE5]  '>Taka :300TK {consultationFee}</p>
			     <p className='text-lg font-medium text-[#0F0F0F40] '> (incl Vat )</p>
			     <p className='text-lg font-medium text-[#176AE5] '> Rer consultation </p>
			</div>
		</div>
	</div>
</section>
