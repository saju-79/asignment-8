...
const Heroo = () => {
    return (
        <div className=' flex flex-col items-center text-center py-20 px-15   my-4   space-y-4 bg-gray-100 rounded-lg'>
           ...
           <div className="flex gap-5">
            ...
            <img className='w-1/2' src="https://i.ibb.co.com/RT3YNhR6/banner-img-2.png" alt="" />
           </div>
        </div>
    );  
};
